#!/usr/bin/perl
# converting fastq lines to fasta and quality files. 
# there is one more perl file that takes the selected ID from good_857-result
# ex. perl fastq2fa_qual.pl < ${fastq_file} > ${fasta_file} 2> ${quality_file}
